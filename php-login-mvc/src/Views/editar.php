...
<body class="d-flex align-items-center py-4 bg-body-tertiary">
    <main class="form-signin w-100 m-auto">
        ...
        <h1>Atualizar</h1>
        <?php if (!empty($error)): ?><p style="color:red;">Erro ao cadastrar. Tente novamente.</p><?php endif; ?>
        ...
        <form method="POST">
            ...
            <button class="btn btn-primary" type="">Atualizar</button>
        </form>
